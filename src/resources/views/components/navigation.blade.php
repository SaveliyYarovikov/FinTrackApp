        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('recurring-operations.index')" :active="request()->routeIs('recurring-operations.*')">
                        {{ __('Recurring Operations') }}
                    </x-nav-link>
...
{{--                        </x-dropdown-link>--}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('recurring-operations.index')" :active="request()->routeIs('recurring-operations.*')">
                {{ __('Recurring Operations') }}
            </x-responsive-nav-link>
